...
private:
    bool createBuffers(uint32_t maxPointsTotal);
    bool createBuildDescriptorSetLayout();
    bool createBuildDescriptorPool(uint32_t maxFramesInFlight);
    bool createBuildDescriptorSets(uint32_t maxFramesInFlight);
